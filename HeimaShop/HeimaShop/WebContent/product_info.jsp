...
<script type="text/javascript">
 function addCart(){
	 var byNum = $("#quantity").val();
	 location.href="${pageContext.request.contextPath}/product?method=Cart&pid=${product.pid}&byNum="+byNum;
 }
</script>
</head>
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div
						...
						<div>
							<a href="${pageContext.request.contextPath}/product?method=FindProductListByCid&cid=${cid}&currentPage=${currentPage }">返回商品列表</a>
						</div>
					</div>
				</div>
			</div>
