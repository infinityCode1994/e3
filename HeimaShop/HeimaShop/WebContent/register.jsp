	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form id="myform" action="${pageContext.request.contextPath}/user?method=Register" method="post" class="form-horizontal" style="margin-top: 5px;">
